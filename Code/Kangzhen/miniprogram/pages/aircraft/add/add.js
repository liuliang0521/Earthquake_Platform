Page({
  ...
  picfunction: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        wx.cloud.uploadFile({
          cloudPath: "air/" + timestamp + ".jpg", // 上传至云端的路径
  ...
  submit: function (e) {
    ...
    if (that.data.img == []) {
      ...
      console.log("调用函数")
      var url = "http://172.19.252.246:7001/map?path=" + that.data.img.join(";")
      wx.request({
        url: url,
        success: function (res) {
